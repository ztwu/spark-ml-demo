package com.iflytek.scala.datatype
...
object LabelPointTest {
    ...
    def main(args: Array[String]): Unit = {
        ...
        //通过稠密向量，创建标注点
        val lp1: LabeledPoint = LabeledPoint(1.0,
            Vectors.dense(1.0, 0.0, 3.0))
        //通过稀疏向量，创建标注点
        val lp2: LabeledPoint = LabeledPoint(0.0,
        ...
        println("label: " + lp2.label)
        println("features: " + lp2.features)
